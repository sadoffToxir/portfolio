...
import type { GLTFResult } from '../../types/Astronaut'
...
function GreetingAstronaut(props: JSX.IntrinsicElements['group']) {
  ...
  // Create materials using useMemo to ensure they're not recreated on re-renders
                ...
                <group name="skeletal3_6">
                  <group name="GLTF_created_0">
                    ...
                    <skinnedMesh
                      ...
                      material={material0} // Use manually created material
